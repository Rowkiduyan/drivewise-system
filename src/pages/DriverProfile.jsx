  ...
  return (
    <div>
      ...
      <input
        ...
        className="mt-1.5 w-full rounded-xl border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm text-slate-900 outline-none transition focus:border-amber-400 focus:bg-white focus:ring-2 focus:ring-amber-100"
      />
    </div>
  );
}
          ...
          <>
            ...
            <section className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
              <div className="flex items-center gap-4">
                <div className="flex h-28 w-28 shrink-0 items-center justify-center overflow-hidden rounded-full bg-amber-50 text-xl font-semibold text-amber-700">
          ...
          >
            ...
            <form onSubmit={handleChangePassword} className="mt-4 flex flex-col gap-4">
              ...
              <div className="mt-1 flex items-center justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="rounded-xl bg-amber-600 px-3.5 py-2 text-sm font-semibold text-white transition hover:bg-amber-700"
                >
                  Update Password
                </button>
              </div>
