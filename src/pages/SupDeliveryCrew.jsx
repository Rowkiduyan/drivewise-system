  ...
  const filteredCrew = useMemo(() => {
    ...
    return crewRecords.filter((crew) => {
      const matchesSearch = !query
        ? true
        : [crew.lastName, crew.firstName, crew.middleName, crew.position, crew.status]
            .join(' ')
            .toLowerCase()
            .includes(query)
              ...
              {filteredCrew.map((crew) => (
                ...
                >
                  <div className="col-span-5">
                    ...
                    <p className="text-xs text-slate-400">Updated {crew.lastUpdated}</p>
                  </div>
                  <div className="col-span-3 text-slate-700">{crew.position}</div>
