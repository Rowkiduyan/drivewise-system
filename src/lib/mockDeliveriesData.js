...
export const completed_delivery_reports = {
  ...
  'DEL-071': {
    routeDeviation: {
      ...
      plannedDistance: '10.4 km',
      actualDistance: '11.2 km',
      deviationDistance: '0.8 km',
      deviationPercent: 7.7,
      aiSummary: 'Minor route deviation detected. The driver took a slightly longer line through the EDSA–Ayala corridor, adding approximately 0.8 km to the planned route. The deviation appears to be a navigation correction to avoid stop-and-go traffic near Guadalupe. No significant impact on delivery time.',
      aiVerdict: 'Minor Deviation',
      aiVerdictTone: 'amber',
      deviationSegments: [
        {
          location: 'EDSA–Ayala corridor',
          extraDistance: '0.8 km',
          reason: 'Traffic avoidance — driver adjusted the line near Guadalupe to keep moving.',
          severity: 'Minor',
        },
      ],
      scheduleImpact: 'No impact on scheduled arrival',
      fuelImpact: 'Negligible — approx. +0.2 L diesel consumed',
      recommendations: [
        'No corrective action required. The deviation was minor and quickly corrected.',
        'Optional: brief drivers on EDSA traffic patterns during weekday mornings.',
      ],
    },
    trip: {
      route: 'Pasay Hub → BGC Branch',
      distance: '11.2 km',
      duration: '4 hr 0 min',
      startTime: '2026-07-28T09:00:00',
      endTime: '2026-07-28T13:00:00',
      scheduledStart: '2026-07-28T08:45:00',
      scheduledEnd: '2026-07-28T13:00:00',
      departedOnTime: true,
      arrivedOnTime: true,
      lateMinutes: 0,
      waitingTime: '20 min',
      idleTime: '5 min',
      stops: [
        { location: 'Pasay Hub', time: '09:00', action: 'Departure' },
        { location: 'EDSA–Guadalupe', time: '09:55', action: 'Waypoint' },
        { location: 'BGC Branch', time: '13:00', action: 'Drop-off Completed' },
      ],
      restStops: [
        {
          location: 'Shell Buendia',
          duration: '10 min',
          purpose: 'Rest break after drowsiness alert — rehydration',
          distanceFromStart: '6.2 km',
          drivingTime: '42 min',
        },
      ],
      timeline: [
        { label: 'Departed for Pickup', time: '08:45', completed: true },
        { label: 'Arrived at Pickup Location', time: '09:00', completed: true },
        { label: 'Departed for Drop Off', time: '09:10', completed: true },
        { label: 'Arrived at Drop Off Location', time: '12:55', completed: true },
        { label: 'Delivery Completed', time: '13:00', completed: true },
      ],
    },
    behavior: {
      totalAlerts: 2,
      ...
      cameraStatus: 'ACTIVE',
      eyeDetection: 'DETECTED',
      avgClosureDuration: '43s',
      yawnCount: 1,
      eyeDetectionFailures: 0,
      alertMechanism: { seatVibration: 'ACTIVE', audioAlert: 'ACTIVE' },
      recommendedRestStop: 'Shell Buendia',
      alertsByType: [
        { type: 'prolonged_eye_closure', count: 1, label: 'Prolonged Eye Closure' },
        { type: 'pattern_repeated_eye_closure', count: 1, label: 'Repeated Eye Closure' },
      ],
      alertHistory: [
        { type: 'Prolonged Eye Closure', time: '2026-07-28 11:12', severity: 'WARNING' },
        { type: 'Repeated Eye Closure', time: '2026-07-28 11:30', severity: 'CRITICAL' },
      ],
      sessions: [
        { start: '2026-07-28T09:00:00', end: '2026-07-28T13:00:00', alerts: 2, duration: 14400 },
      ],
      analysis:
        'The camera-based driver monitoring system tracked the driver across the 4-hour delivery run. Two drowsiness triggers were recorded around midday — one prolonged eye-closure and one repeated eye-closure pattern. The seat vibration unit and audio alerts fired immediately on each trigger. Eye detection remained stable with no failures. A rest stop at Shell Buendia was recommended and taken. Overall driver risk is LOW-to-MODERATE for this trip.',
    },
    delivery: {
      totalAlerts: 2,
      totalSessions: 1,
      avgAlertDuration: '43s',
      peakAlertTime: '11:30 AM',
      eyeClosureAlerts: [
        { id: 'A-8', time: '2026-07-28T11:12:00', type: 'prolonged_eye_closure', duration: 40, severity: 'Moderate' },
        { id: 'A-9', time: '2026-07-28T11:30:00', type: 'pattern_repeated_eye_closure', duration: 45, severity: 'High' },
      ],
    },
  },
  'DEL-072': {
    routeDeviation: {
      ...
      plannedDistance: '7.1 km',
      actualDistance: '8.0 km',
      deviationDistance: '0.9 km',
      deviationPercent: 12.7,
      aiSummary: 'Minor route deviation detected. The driver cut through the Eastwood back roads instead of staying on C5, adding roughly 0.9 km to the planned route. The deviation appears intentional for traffic avoidance and did not delay the arrival.',
      aiVerdict: 'Minor Deviation',
      aiVerdictTone: 'amber',
      deviationSegments: [
        {
          location: 'Eastwood back roads',
          extraDistance: '0.9 km',
          reason: 'Traffic avoidance — driver used side roads to bypass congestion on C5.',
          severity: 'Minor',
        },
      ],
      scheduleImpact: 'No impact on scheduled arrival',
      fuelImpact: 'Negligible — approx. +0.3 L diesel consumed',
      recommendations: [
        'No corrective action required. The deviation was minor and quickly corrected.',
      ],
    },
    trip: {
      route: 'Quezon City Hub → Ortigas Branch',
      distance: '8.0 km',
      duration: '4 hr 30 min',
      startTime: '2026-07-30T08:00:00',
      endTime: '2026-07-30T12:30:00',
      scheduledStart: '2026-07-30T07:45:00',
      scheduledEnd: '2026-07-30T12:30:00',
      departedOnTime: true,
      arrivedOnTime: true,
      lateMinutes: 0,
      waitingTime: '25 min',
      idleTime: '10 min',
      stops: [
        { location: 'Quezon City Hub', time: '08:00', action: 'Departure' },
        { location: 'C5 Checkpoint', time: '08:40', action: 'Waypoint' },
        { location: 'Ortigas Branch', time: '12:30', action: 'Drop-off Completed' },
      ],
      restStops: [
        {
          location: 'Caltex C5 Road',
          duration: '15 min',
          purpose: 'Rest stop — driver fatigue detected by DriveWise',
          distanceFromStart: '4.5 km',
          drivingTime: '25 min',
        },
      ],
      timeline: [
        { label: 'Departed for Pickup', time: '07:45', completed: true },
        { label: 'Arrived at Pickup Location', time: '08:00', completed: true },
        { label: 'Departed for Drop Off', time: '08:15', completed: true },
        { label: 'Arrived at Drop Off Location', time: '12:20', completed: true },
        { label: 'Delivery Completed', time: '12:30', completed: true },
      ],
    },
    behavior: {
      totalAlerts: 3,
      avgAlertsPerTrip: 3.0,
      riskLevel: getRiskLevel(3),
      drowsinessLevel: 'MODERATE',
      cameraStatus: 'ACTIVE',
      eyeDetection: 'DETECTED',
      avgClosureDuration: '49s',
      yawnCount: 2,
      eyeDetectionFailures: 1,
      alertMechanism: { seatVibration: 'ACTIVE', audioAlert: 'ACTIVE' },
      recommendedRestStop: 'Caltex C5 Road',
      alertsByType: [
        { type: 'prolonged_eye_closure', count: 2, label: 'Prolonged Eye Closure' },
        { type: 'pattern_eye_closure_yawn', count: 1, label: 'Eye Closure + Yawn' },
      ],
      alertHistory: [
        { type: 'Prolonged Eye Closure', time: '2026-07-30 10:05', severity: 'WARNING' },
        { type: 'Eye Closure + Yawn', time: '2026-07-30 10:22', severity: 'CRITICAL' },
        { type: 'Prolonged Eye Closure', time: '2026-07-30 11:10', severity: 'WARNING' },
      ],
      sessions: [
        { start: '2026-07-30T08:00:00', end: '2026-07-30T12:30:00', alerts: 3, duration: 16200 },
      ],
      analysis:
        'The camera-based driver monitoring system recorded a MODERATE drowsiness level over the delivery run. Three drowsiness triggers were logged — two prolonged eye-closures and one eye-closure-plus-yawn pattern. The seat vibration unit and audio alerts fired on each trigger. A single eye-detection failure was recorded. A rest stop at Caltex C5 Road was recommended and taken. Given the moderate reading, the driver should be monitored on the next dispatch.',
    },
    delivery: {
      totalAlerts: 3,
      totalSessions: 1,
      avgAlertDuration: '49s',
      peakAlertTime: '10:22 AM',
      eyeClosureAlerts: [
        { id: 'A-10', time: '2026-07-30T10:05:00', type: 'prolonged_eye_closure', duration: 50, severity: 'Moderate' },
        { id: 'A-11', time: '2026-07-30T10:22:00', type: 'pattern_eye_closure_yawn', duration: 45, severity: 'High' },
        { id: 'A-12', time: '2026-07-30T11:10:00', type: 'prolonged_eye_closure', duration: 48, severity: 'Moderate' },
      ],
    },
  },
  'DEL-073': {
    routeDeviation: {
      ...
      plannedDistance: '3.6 km',
      actualDistance: '3.8 km',
      deviationDistance: '0.2 km',
      deviationPercent: 5.6,
      aiSummary: 'Negligible route deviation detected. The driver deviated slightly around the Makati underpass construction site, adding only 0.2 km to the planned route. No impact on delivery time, fuel consumption, or safety.',
      aiVerdict: 'Normal',
      aiVerdictTone: 'emerald',
      deviationSegments: [
        {
          location: 'Makati underpass construction',
          extraDistance: '0.2 km',
          reason: 'Construction detour — driver re-joined the planned route immediately after.',
          severity: 'None',
        },
      ],
      scheduleImpact: 'No impact on scheduled arrival',
      fuelImpact: 'None',
      recommendations: [
        'No corrective action required. The deviation was negligible and quickly corrected.',
      ],
    },
    trip: {
      route: 'Mandaluyong Hub → Greenbelt Branch',
      distance: '3.8 km',
      duration: '1 hr 40 min',
      startTime: '2026-08-01T07:00:00',
      endTime: '2026-08-01T08:40:00',
      scheduledStart: '2026-08-01T06:45:00',
      scheduledEnd: '2026-08-01T08:40:00',
      departedOnTime: true,
      arrivedOnTime: true,
      lateMinutes: 0,
      waitingTime: '15 min',
      idleTime: '4 min',
      stops: [
        { location: 'Mandaluyong Hub', time: '07:00', action: 'Departure' },
        { location: 'EDSA–Boni Interchange', time: '07:25', action: 'Waypoint' },
        { location: 'Greenbelt Branch', time: '08:40', action: 'Drop-off Completed' },
      ],
      restStops: [],
      timeline: [
        { label: 'Departed for Pickup', time: '06:45', completed: true },
        { label: 'Arrived at Pickup Location', time: '07:00', completed: true },
        { label: 'Departed for Drop Off', time: '07:10', completed: true },
        { label: 'Arrived at Drop Off Location', time: '08:35', completed: true },
        { label: 'Delivery Completed', time: '08:40', completed: true },
      ],
    },
    behavior: {
      totalAlerts: 0,
      avgAlertsPerTrip: 0.0,
      riskLevel: getRiskLevel(0),
      drowsinessLevel: 'LOW',
      cameraStatus: 'ACTIVE',
      eyeDetection: 'DETECTED',
      avgClosureDuration: '0s',
      yawnCount: 0,
      eyeDetectionFailures: 0,
      alertMechanism: { seatVibration: 'ACTIVE', audioAlert: 'ACTIVE' },
      ...
      alertHistory: [],
      sessions: [
        { start: '2026-08-01T07:00:00', end: '2026-08-01T08:40:00', alerts: 0, duration: 6000 },
      ],
      analysis:
        'The camera-based driver monitoring system tracked the driver for the full short trip. No drowsiness triggers were recorded. Eye detection remained stable with no failures and the driver stayed alert throughout the run. No rest stop was required. Overall driver risk is LOW for this trip.',
    },
    delivery: {
      totalAlerts: 0,
      totalSessions: 1,
