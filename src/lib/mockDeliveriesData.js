...
export const customer_deliveries = [
  {
    ...
    dropoff_location:
      "123 Main Street, Brgy. Central, Quezon City, Metro Manila",
    budget_min: 3000,
    budget_max: 5000,
  ...
  },
  {
    ...
    dropoff_location:
      "Goldilocks SM Dasma, Brgy. Paliparan III, Dasmariñas, Cavite",
    budget_min: 4500,
    budget_max: 6000,
  ...
  },
  {
    ...
    dropoff_time: "14:00",
    pickup_location:
      "Puregold Warehouse, Brgy. San Bartolome, Novaliches, Quezon City",
  ...
  },
  {
    ...
    dropoff_location:
      "NBS SM North EDSA Branch, Brgy. Bagong Pag-asa, Quezon City",
    budget_min: 2800,
    budget_max: 4000,
...
export const delivery_alert_monitoring = [
  {
    ...
    alert_history: [
      {
        type: "Repeated eye closure",
        time: "2026-07-26 09:52",
        severity: "WARNING",
      },
  ...
  },
  {
    ...
    alert_history: [
      {
        type: "Repeated eye closure",
        time: "2026-07-26 09:41",
        severity: "WARNING",
      },
      {
        type: "Eye detection failure",
        time: "2026-07-26 09:47",
        severity: "WARNING",
      },
      {
        type: "Repeated eye closure",
        time: "2026-07-26 09:55",
        severity: "WARNING",
      },
      ...
      {
        type: "Prolonged eye closure",
        time: "2026-07-26 10:06",
        severity: "CRITICAL",
      },
    ],
  },
  {
    ...
    alert_history: [
      {
        type: "Eye detection failure",
        time: "2026-07-26 09:50",
        severity: "WARNING",
      },
      {
        type: "Repeated eye closure",
        time: "2026-07-26 09:56",
        severity: "WARNING",
      },
      { type: "Yawn detected", time: "2026-07-26 10:01", severity: "INFO" },
      {
        type: "Repeated eye closure",
        time: "2026-07-26 10:04",
        severity: "WARNING",
      },
      {
        type: "Prolonged eye closure",
      ...
      {
        type: "Eye detection failure",
        time: "2026-07-26 10:08",
        severity: "CRITICAL",
      },
      {
        type: "Eye detection failure",
        time: "2026-07-26 10:09",
        severity: "CRITICAL",
      },
    ],
  },
...
export const delivery_supervisor_data = {
  ...
  "DEL-018": {
    ...
    crew: {
      ...
      truck: { plateNumber: "DEF 9012", truckType: "LUV", capacity: "1.0 ton" },
    },
...
export const completed_delivery_reports = {
  "DEL-004": {
      ...
      deviationSegments: [
        {
          ...
          reason:
            "Navigation correction — driver turned north briefly before re-joining the planned route.",
          severity: "Minor",
        },
      ],
      ...
      restStops: [
        {
          ...
          duration: "10 min",
          purpose:
            "Rest break after drowsiness alert — rehydration and leg stretch",
    ...
    behavior: {
      ...
      alertHistory: [
        {
          type: "Prolonged Eye Closure",
          time: "2026-07-20 08:42",
          severity: "WARNING",
        },
        {
          type: "Repeated Eye Closure",
          time: "2026-07-20 08:55",
          severity: "CRITICAL",
        },
      ],
      sessions: [
  ...
  "DEL-005": {
      ...
      deviationSegments: [
        {
          ...
          reason:
            "Driver took an alternative route through residential roads instead of staying on Aguinaldo Highway.",
    ...
    behavior: {
      ...
      alertHistory: [
        {
          type: "Prolonged Eye Closure",
          time: "2026-07-19 06:12",
          severity: "WARNING",
        },
        {
          type: "Eye Closure + Yawn",
          time: "2026-07-19 06:20",
          severity: "WARNING",
        },
        {
          type: "Eye Closure + Yawn",
          time: "2026-07-19 06:28",
          severity: "CRITICAL",
        },
        {
          type: "Prolonged Eye Closure",
          time: "2026-07-19 06:35",
          severity: "WARNING",
        },
        {
          type: "Repeated Eye Closure",
          time: "2026-07-19 06:42",
          severity: "CRITICAL",
        },
      ],
      sessions: [
  ...
  "DEL-071": {
    routeDeviation: {
      ...
      aiSummary:
        "Minor route deviation detected. The driver took a slightly longer line through the EDSA–Ayala corridor, adding approximately 0.8 km to the planned route. The deviation appears to be a navigation correction to avoid stop-and-go traffic near Guadalupe. No significant impact on delivery time.",
      aiVerdict: "Minor Deviation",
      aiVerdictTone: "amber",
      deviationSegments: [
        {
          ...
          reason:
            "Traffic avoidance — driver adjusted the line near Guadalupe to keep moving.",
          severity: "Minor",
        },
      ],
      scheduleImpact: "No impact on scheduled arrival",
  ...
  "DEL-072": {
    routeDeviation: {
      ...
      aiSummary:
        "Minor route deviation detected. The driver cut through the Eastwood back roads instead of staying on C5, adding roughly 0.9 km to the planned route. The deviation appears intentional for traffic avoidance and did not delay the arrival.",
      aiVerdict: "Minor Deviation",
      aiVerdictTone: "amber",
      deviationSegments: [
        {
          ...
          reason:
            "Traffic avoidance — driver used side roads to bypass congestion on C5.",
          severity: "Minor",
        },
      ],
      scheduleImpact: "No impact on scheduled arrival",
    ...
    behavior: {
      ...
      alertHistory: [
        {
          type: "Prolonged Eye Closure",
          time: "2026-07-30 10:05",
          severity: "WARNING",
        },
        {
          type: "Eye Closure + Yawn",
          time: "2026-07-30 10:22",
          severity: "CRITICAL",
        },
        {
          type: "Prolonged Eye Closure",
          time: "2026-07-30 11:10",
          severity: "WARNING",
        },
      ],
      sessions: [
  ...
  "DEL-073": {
    routeDeviation: {
      ...
      aiSummary:
        "Negligible route deviation detected. The driver deviated slightly around the Makati underpass construction site, adding only 0.2 km to the planned route. No impact on delivery time, fuel consumption, or safety.",
      aiVerdict: "Normal",
      ...
      deviationSegments: [
        {
          ...
          reason:
            "Construction detour — driver re-joined the planned route immediately after.",
          severity: "None",
        },
      ],
      scheduleImpact: "No impact on scheduled arrival",
    ...
    trip: {
      ...
      stops: [
        ...
        {
          location: "EDSA–Boni Interchange",
          time: "07:25",
          action: "Waypoint",
        },
        {
          location: "Greenbelt Branch",
          time: "08:40",
          action: "Drop-off Completed",
        },
      ],
