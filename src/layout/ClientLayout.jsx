  ...
  return (
    <main className="relative h-screen overflow-hidden bg-white text-slate-900">
      ...
      <section className="relative mx-auto flex h-full w-full max-w-none gap-0">
        <aside
          className={`sticky top-0 flex h-screen shrink-0 flex-col items-center gap-5 border-r border-emerald-200/70 bg-emerald-50/80 px-2 py-4 backdrop-blur transition-all duration-200 ${
